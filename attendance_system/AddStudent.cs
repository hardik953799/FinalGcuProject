...
namespace attendance_system
{
    public partial class AddStudent : Form
    {
        ...
        private void buttonAdd_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                string query = "insert into facerecognition.student(name, roll,  course_code, course_id,session) values('" + this.nameBox.Text + "'," + this.rollBox.Text + ",'" + classControl.course_code + "'," + classControl.course_id + ", '"+ this.sessionBox.Text +"'); ";
        ...
        private void buttonUpload_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                foreach (DataRow item in dt.Rows)
                {
                    ...
                    try
                    {
                        string query = "insert into facerecognition.student(name, roll, course_code, course_id, session) values('" + dataGridView1.Rows[n].Cells[1].Value + "', " + dataGridView1.Rows[n].Cells[0].Value + ", '" + classControl.course_code + "' , " + classControl.course_id + " ,'" + dataGridView1.Rows[n].Cells[2].Value + "') ";
