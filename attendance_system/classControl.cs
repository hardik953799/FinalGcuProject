...
namespace attendance_system
{
    public partial class classControl : UserControl
    {
        ...
        private void show_course()
        {
            ...
            try
            {
                string query = "select * from facerecognition.course where teacher_id = " + Form1.user_id + " ";
        ...
        private void dataGridView1_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            try
            {
                ...
                if (e.ColumnIndex == 3)  //delete
                {
                    ...
                    {
                        MySqlConnection conn2 = new MySqlConnection(conn);
                        string query = " delete from facerecognition.course where teacher_id = " + Form1.user_id + " and course_code = '" + dataGridView1.Rows[e.RowIndex].Cells[0].Value.ToString() + "' ";
        ...
        private int get_id(string course_code){
              try
            {
                ...
                string cmd = "select id from facerecognition.course where teacher_id = " + Form1.user_id +" and course_code = '"+ course_code +"'";
