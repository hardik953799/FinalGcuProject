...
namespace attendance_system
{
    public partial class createClassControl : UserControl
    {
        ...
        private void button_insert_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                string query = "insert into facerecognition.course(teacher_id, course_code, course_title,semester) values(" + Form1.user_id + ",'" + this.ccodeBox.Text + "','" + this.ctitleBox.Text + "','" + this.semBox.Text + "'); ";
