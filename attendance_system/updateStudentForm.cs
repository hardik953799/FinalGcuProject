    ...
    public partial class updateStudentForm : Form
    {
        ...
        private void show_data()
        {
            try
            {
                ...
                string query = " select * from facerecognition.student where  id = " + TakeAttendanceForm.current_student_id + "  ";
        ...
        private void buttonUpdate_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                MySqlConnection conn2 = new MySqlConnection(conn);
                string query = "update facerecognition.student set roll  = " + Convert.ToInt32(roll) + ", name = '" + name + "', session = '" + session + "' where id = " + TakeAttendanceForm.current_student_id + "  ";
