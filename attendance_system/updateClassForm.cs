    ...
    public partial class updateClassForm : Form
    {
        ...
        private void show_data()
        {
            try
            {
                ...
                string query = " select * from facerecognition.course where  id = " + classControl.course_id + "  ";
        ...
        private void button_update_Click(object sender, EventArgs e)
        {
            ...
            MySqlConnection conn2 = new MySqlConnection(conn);
            string query = "update facerecognition.course set course_code  = '" + ccode + "', course_title = '" + ctitle + "', semester = '" + sem + "' where id = " + classControl.course_id + "  ";
